...
\begin{center}
    ...
    \small \faicon{phone} \texttt{+7 (916) 744-21-25} \hspace{1pt} \textbar
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{vicktoriamilewskaya@yandex.ru} \hspace{1pt} $|$ 
    \hspace{1pt} \faMapMarker \hspace{2pt}\texttt{ г. Москва}
    \\ \vspace{-3pt}
\end{center}
